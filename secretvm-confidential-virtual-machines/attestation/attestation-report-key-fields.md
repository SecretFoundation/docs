...
| **reportdata**                                                          | <p>A special field that concatenates:<br>- The <strong>fingerprint of the TLS certificate</strong> generated on the VM. T<br>- The <strong>nonce of the GPU Attestation Quote</strong> (for GPU-enabled machines only).</p>                                                                                                                                     |

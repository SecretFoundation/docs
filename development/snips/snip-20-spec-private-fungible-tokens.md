...
Set a viewing key with a predefined value for Cosmos message sender, _without_ creating it. This is useful to manage multiple SNIP-20 tokens using the same viewing key.

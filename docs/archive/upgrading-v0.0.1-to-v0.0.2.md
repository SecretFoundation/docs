...
:warning: If you are upgrading a validator node please [make sure to back it up before you make any changes.](../node-guides/backup-a-validator.md) :warning:
...
Follow the [How to migrate a validator to a new machine](../node-guides/migrate-a-validator.md) guide while installing v0.0.2 on the new machine.

# Full nodes that are not validators

- If you do care about downtime:

  Follow the [How to deploy a full node](../node-guides/run-full-node-mainnet.md) guide while installing v0.0.2 on the new machine.

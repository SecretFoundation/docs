...
if (($UBUNTUVERSION > 18)); then
   ...
   wget -O /tmp/libprotobuf30_3.19.3-1_amd64.deb http://ftp.br.debian.org/debian/pool/main/p/protobuf/libprotobuf30_3.19.3-1_amd64.deb
   yes | sudo gdebi /tmp/libprotobuf30_3.19.3-1_amd64.deb
else

...
4. We are also replacing our WASM engine with a newer, more performant one. This item is still on the [roadmap](../../secret-network-overview/roadmap.md) and will help with long term scalability of Secret Network.

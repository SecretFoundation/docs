...
Ensure your hardware is [Secret Node Compliant](https://docs.scrt.network/node-guides/hardware-compliance.html).
...
## [#](https://docs.scrt.network/node-guides/setup-sgx.html#installation)Installation <a href="#installation" id="installation"></a>

### [#](https://docs.scrt.network/node-guides/setup-sgx.html#for-node-runners)For Node Runners <a href="#for-node-runners" id="for-node-runners"></a>

#### [#](https://docs.scrt.network/node-guides/setup-sgx.html#install-sgx)Install SGX <a href="#install-sgx" id="install-sgx"></a>
...
## [#](https://docs.scrt.network/node-guides/setup-sgx.html#testing-your-sgx-setup)Testing your SGX setup <a href="#testing-your-sgx-setup" id="testing-your-sgx-setup"></a>

#### [#](https://docs.scrt.network/node-guides/setup-sgx.html#run-secretd-init-enclave)Run `secretd init-enclave` <a href="#run-secretd-init-enclave" id="run-secretd-init-enclave"></a>

See [Verify SGX](https://docs.scrt.network/node-guides/verify-sgx.html) for a guide how to test your setup.

## [#](https://docs.scrt.network/node-guides/setup-sgx.html#uninstall)Uninstall <a href="#uninstall" id="uninstall"></a>
...
## [#](https://docs.scrt.network/node-guides/setup-sgx.html#refs)Refs <a href="#refs" id="refs"></a>
...
[**#**](https://docs.scrt.network/node-guides/setup-sgx.html#contributers)**Contributers**

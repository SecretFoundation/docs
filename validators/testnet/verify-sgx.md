...
### [#](https://docs.scrt.network/testnet/verify-sgx.html#instructions)Instructions <a href="#instructions" id="instructions"></a>

These instructions refer to an installation using:

* Ubuntu 18.04 or 20.04
* SGX driver [sgx\_linux\_x64\_driver\_2.6.0\_602374c.bin](https://download.01.org/intel-sgx/sgx-linux/2.9.1/distro/ubuntu18.04-server/sgx\_linux\_x64\_driver\_2.6.0\_602374c.binn)
* Intel SGX PSW 2.9.101.2

See SGX installation instructions [here](https://docs.scrt.network/node-guides/setup-sgx.html)
...
#### [#](https://docs.scrt.network/testnet/verify-sgx.html#\_1-download-the-test-package)1. Download the test package <a href="#_1-download-the-test-package" id="_1-download-the-test-package"></a>

wget https://github.com/chainofsecrets/SecretNetwork/releases/download/v1.0.0/secretnetwork\_1.0.0\_amd64.deb

#### [#](https://docs.scrt.network/testnet/verify-sgx.html#\_2-unpack)2. Unpack <a href="#_2-unpack" id="_2-unpack"></a>

[**#**](https://docs.scrt.network/testnet/verify-sgx.html#this-will-install-secretd)**This will install `secretd`**

```
sudo dpkg -i secretnetwork_1.0.0_amd64.deb
```

#### [#](https://docs.scrt.network/testnet/verify-sgx.html#\_3-initialize-the-enclave)3. Initialize the enclave <a href="#_3-initialize-the-enclave" id="_3-initialize-the-enclave"></a>
...
#### [#](https://docs.scrt.network/testnet/verify-sgx.html#\_4-what-to-do-if-this-didn-t-work)4. What to do if this didn't work? <a href="#_4-what-to-do-if-this-didn-t-work" id="_4-what-to-do-if-this-didn-t-work"></a>
...
#### [#](https://docs.scrt.network/testnet/verify-sgx.html#\_5-troubleshooting)5. Troubleshooting <a href="#_5-troubleshooting" id="_5-troubleshooting"></a>

[**#**](https://docs.scrt.network/testnet/verify-sgx.html#output-is)**Output is:**
...
[**#**](https://docs.scrt.network/testnet/verify-sgx.html#output-is-2)**Output is:**
...
[**#**](https://docs.scrt.network/testnet/verify-sgx.html#output-is-3)**Output is:**
...
[**#**](https://docs.scrt.network/testnet/verify-sgx.html#i-m-seeing-sgx-error-device-busy)**I'm seeing `SGX_ERROR_DEVICE_BUSY`**

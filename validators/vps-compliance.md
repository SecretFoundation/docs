...
[**#**](https://docs.scrt.network/node-guides/vps-compliance.html#microsoft-azure-confidential-computing)[**Microsoft Azure Confidential Computing**](https://azure.microsoft.com/en-us/solutions/confidential-compute/)

Cost estimate: TBD

Find the detailed step by step instructions [here](https://docs.scrt.network/node-guides/azure.html)

[**#**](https://docs.scrt.network/node-guides/vps-compliance.html#psychz)[**Psychz**](https://www.psychz.net/dashboard/client/web/order/dedicated-server?processor=\&processorBaseFreq=\&numberOfCpu=7391\&cpuCores=\&location=)

Cost estimate: $144/mo

Find the detailed step by step instructions [here](https://docs.scrt.network/node-guides/psychz.html)

[**#**](https://docs.scrt.network/node-guides/vps-compliance.html#nforce)[**nforce**](https://www.nforce.com/customserver)

Cost estimate: $95/mo

Find the detailed step by step instructions [here](https://docs.scrt.network/node-guides/nforce.html)

[**#**](https://docs.scrt.network/node-guides/vps-compliance.html#leaseweb)[**leaseweb**](https://www.leaseweb.com/dedicated-servers/build-your-own)

Cost estimate: $89/mo

Find the detailed step by step instructions [here](https://docs.scrt.network/node-guides/leaseweb.html)

[**#**](https://docs.scrt.network/node-guides/vps-compliance.html#vultr)[**Vultr**](https://www.vultr.com/products/bare-metal/)

Cost estimate: $185/mo

Find the detailed step by step instructions [here](https://docs.scrt.network/node-guides/vultr.html)

[**#**](https://docs.scrt.network/node-guides/vps-compliance.html#phoenixnap)[**Phoenixnap**](https://admin.phoenixnap.com/wap-pncpadmin-shell/orderForm?bmbPath=/order-management/order-form?currencyCode=usd)

Cost estimate: $210/mo

Find the detailed step by step instructions [here](https://docs.scrt.network/node-guides/phoenixnap.html)

[**#**](https://docs.scrt.network/node-guides/vps-compliance.html#contributers)**Contributers**

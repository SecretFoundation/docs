...
* [Setting up a node/validator](infrastructure/setting-up-a-node-validator/README.md)
  ...
  * [Testnet Setup](infrastructure/setting-up-a-node-validator/testnet/README.md)
    * [Install SGX (new DCAP)](infrastructure/setting-up-a-node-validator/testnet/install-sgx-1.md)
    * [Install SGX (old EPID)](infrastructure/setting-up-a-node-validator/testnet/install-sgx.md)
  ...
  * [Mainnet Setup](infrastructure/setting-up-a-node-validator/node-setup/README.md)
    * [Install SGX (new DCAP)](infrastructure/setting-up-a-node-validator/node-setup/install-sgx-1.md)
    * [Install SGX (old EPID)](infrastructure/setting-up-a-node-validator/node-setup/install-sgx.md)
    ...
    * [Installing CLI & Creating A New Address](infrastructure/setting-up-a-node-validator/node-setup/installing-cli-and-creating-a-new-address.md)
...
* [API Noderunning](infrastructure/api-noderunning/README.md)
  * [Running Multiple Nodes on the Same Server](infrastructure/api-noderunning/running-multiple-nodes-on-the-same-server.md)
  * [Node Loadbalancing using Nginx](infrastructure/api-noderunning/node-loadbalancing-using-nginx/README.md)
    * [Setup Nginx](infrastructure/api-noderunning/node-loadbalancing-using-nginx/setup-nginx.md)
    * [Example Nginx config](infrastructure/api-noderunning/node-loadbalancing-using-nginx/example-nginx-config.md)
  * [Using Auto heal to improve cluster uptime for Nginx](infrastructure/api-noderunning/using-auto-heal-to-improve-cluster-uptime-for-nginx.md)
